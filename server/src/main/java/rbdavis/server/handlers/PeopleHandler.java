...
public class PeopleHandler extends Handler implements HttpHandler {
        ...
        switch (exchange.getRequestMethod().toLowerCase()) {
            case "get":
                try {
                    ...
                    PeopleRequest request = gson.fromJson(reqData, PeopleRequest.class);
                    if (isValidPeopleRequest(request)) {
    ...
    private boolean isValidPeopleRequest(PeopleRequest request) throws NullPointerException {
